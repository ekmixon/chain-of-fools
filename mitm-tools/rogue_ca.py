...
def generate_ca(common_name):
    ...
    certificate = (
        ...
        .subject_name(
            x509.Name(
                [
                    ...
                    x509.NameAttribute(
                        NameOID.ORGANIZATION_NAME, u'Duo Security'
                    ),
                    x509.NameAttribute(
                        NameOID.ORGANIZATIONAL_UNIT_NAME, u'Duo Labs'
                    ),
                ]
            )
        )
        ...
        .not_valid_before(datetime.datetime.now() - one_day)
        .not_valid_after(datetime.datetime(2022, 8, 2))
